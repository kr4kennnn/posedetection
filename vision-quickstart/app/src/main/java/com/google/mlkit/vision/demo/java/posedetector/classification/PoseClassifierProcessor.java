...
public class PoseClassifierProcessor {
  ...
  private static final String BIRDDOG_CLASS = "birddog_down";
  private static final String LEGRISE_CLASS = "legsiderise_down";
  private static final String PULLUPS_CLASS = "pullups_down";
  private static final String SITUPS_CLASS = "situps_down";
  private static final String[] POSE_CLASSES = {
    PUSHUPS_CLASS, SQUATS_CLASS, BIRDDOG_CLASS, LEGRISE_CLASS, PULLUPS_CLASS, SITUPS_CLASS
  };
